...
export default function Contact() {
  ...
  const handleSubmit = e => {
    ...
    setSending(true);
    setTimeout(() => { setSending(false); setSent(true); setForm({ name: '', email: '', message: '' }); }, 1500);
  };

  // Glow on click of section
  ...
  return (
    <section id="contact" style={{ padding: '2rem 1.5rem', background: 'var(--black)' }} onClick={handleSectionClick}>
      {/* Outer wrapper with rounded black panels top & bottom */}
      <div
        ref={sectionRef}
        style={{
          background: '#0e0e0c',
          ...
          boxShadow: glowing
            ? '0 0 0 2px var(--terra), 0 0 60px rgba(184,114,74,0.35), 0 0 120px rgba(184,114,74,0.12)'
            : '0 0 0 1px rgba(255,255,255,0.05)',
        }}
      >
        {/* Top rounded arc decoration */}
        <div style={{
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(184,114,74,0.06) 0%, transparent 70%)',
          pointerEvents: 'none',
        }} />
        ...
        <div className="container">
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.5fr', gap: '5rem', alignItems: 'start' }} className="contact-grid">
            ...
            <div>
              ...
              <p style={{ fontSize: '0.9rem', color: 'rgba(255,255,255,0.5)', lineHeight: 1.85, marginBottom: '3rem' }}>
                Whether you have a partnership opportunity, a business development role, or a design project — I'd love to hear from you.
              </p>

              {/* Contact info */}
              <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                <div>
                  <p style={{ ...labelStyle, marginBottom: '0.4rem' }}>LinkedIn</p>
                  <a href="https://linkedin.com/in/panktipatel23" target="_blank" rel="noreferrer"
                    style={{ color: 'var(--white)', fontWeight: 500, fontSize: '0.9rem', display: 'inline-flex', alignItems: 'center', gap: '0.3rem' }}>
                ...
                <div>
                  <p style={{ ...labelStyle, marginBottom: '0.4rem' }}>Based in</p>
                  <p style={{ color: 'var(--white)', fontWeight: 500, fontSize: '0.9rem' }}>Germany · Open to Europe-wide roles</p>
                </div>
              </div>
            </div>
            ...
            >
              <div>
                ...
                <input name="name" value={form.name} onChange={handleChange}
                  ...
                  style={{ ...inputBase, borderColor: errors.name ? 'var(--terra)' : 'rgba(255,255,255,0.12)' }}
                  onFocus={e => e.target.style.borderColor = 'rgba(255,255,255,0.35)'}
                  onBlur={e => e.target.style.borderColor = errors.name ? 'var(--terra)' : 'rgba(255,255,255,0.12)'}
                />
              ...
              <div>
                ...
                <input name="email" type="email" value={form.email} onChange={handleChange}
                  ...
                  style={{ ...inputBase, borderColor: errors.email ? 'var(--terra)' : 'rgba(255,255,255,0.12)' }}
                  onFocus={e => e.target.style.borderColor = 'rgba(255,255,255,0.35)'}
                  onBlur={e => e.target.style.borderColor = errors.email ? 'var(--terra)' : 'rgba(255,255,255,0.12)'}
                />
              ...
              <div>
                ...
                <textarea name="message" rows={5} value={form.message} onChange={handleChange}
                  ...
                  style={{ ...inputBase, borderColor: errors.message ? 'var(--terra)' : 'rgba(255,255,255,0.12)', resize: 'vertical' }}
                  onFocus={e => e.target.style.borderColor = 'rgba(255,255,255,0.35)'}
                  onBlur={e => e.target.style.borderColor = errors.message ? 'var(--terra)' : 'rgba(255,255,255,0.12)'}
                />
